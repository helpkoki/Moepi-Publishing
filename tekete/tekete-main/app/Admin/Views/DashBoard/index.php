...
if ($admino == "") {
    echo "<script>alert('sessions expired');</script>";
    echo "<script>window.location.href='../adminLogin';</script>";
}
$mysql = "select count(*) from incidents where status is null";
$myres = mysqli_query($connection, $mysql);

$myrow = mysqli_fetch_row($myres);


$sql = "select * from  company where admin_no='$admino'";
...
<head>
   ...
   <link rel="stylesheet" href="../../../../public/assets/css/admin/dashboard[1].css">
    ...
    <div id="wrapper">
        ...
        <div class="sidebar_2" id="sideba">
            <div class="admin ">
                ...
                <div class="items">
                    <a class="new" href="dashboard.php "> <i class="fas fa-fw fa-tachometer" aria-hidden="true"></i>
                        &nbsp;&nbsp;Dashboard &nbsp;</a>
                    <a class="new" href="index.php">
                        <i class="fa fa-user-circle" aria-hidden="true"></i>Admin</a>
                </div>
                <?php if ($rows[3] != 'Sub') { ?>
                    <div class="items">
                        <a class="dropbtn" style="text-decoration:none" onclick="view('technician')"> <i
                                class="fa fa-user-circle" aria-hidden="true"></i>Technician&nbsp; &nbsp; &nbsp;</a>
                    ...
                    <div class="items">
                        <a class="" onclick="view('companys')" style="color:#5543ca;"> <i class="fa fa-user-circle icons"
                ...
                <div class="items">
                    <a a class="dropbtn" style="text-decoration:none" onclick="view('status')"><i
                            class="fa fa-traffic-light" aria-hidden="true"></i>Status</a>
                ...
                <div class="items">
                    <a class="new" href="logout.php" /><i class="fa fa-user-circle" aria-hidden="true"> </i>logout.
                    &nbsp;&nbsp;&nbsp;&nbsp;</a>
                </div>
            </div>
        </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column body" style="">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow"
                    style="z-index:99999999999;height:40px">
                    ...
                    <a class="cname" style=""><?php echo strtoupper($rows[1]); ?></a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin-top:4%">
                        ...
                        <div class="d-sm-flex align-items-center" style="margin-top:-0.5%">
                            ...
                            <!-- Topbar Navbar -->
                            <div class="form-group" <?php if ($rows[3] == 'Sub') {
                                echo "style='display:none'";
                            } ?>>
                                <label>Company</label>
                                <select class="" aria-label="Filter" style="" name="company" id="company"
                                    onchange="company()">
                                    <option selected style="font-size:16px"
                                        value=" <?php if ($rows[3] == 'Sub') {
                                            echo " AND company_id=" . $rows[0];
                                        } ?>">
                                    </option>
                                    <?php
                                    $companySql = "select * from company";
                                    $companyRes = mysqli_query($connection, $companySql);

                                    while ($row = mysqli_fetch_assoc($companyRes)) {

                                        echo '<option style="font-size:16px" value=" AND company_id=' . $row['company_id'] . '">' . $row['c_name'] . '</option>';
                            ...
                            <div class="form-group" onclick='openDrop()' onclick="openDrop()">
                                ...
                                <select class="" aria-label="Filter" style="" id="filterValue" onchange="fill()"
                                    onclick="fill()">
                        ...
                        <div class="popup" id="popup" style="display:none">
                            <div style="" class="fill" id="fill">
                                From: <input type="date" id="start" name="trip-start" value="2020-01-01"
                                    min="2020-01-01" max="<?php echo date("Y-m-d"); ?>" class="custome_b"
                                    style="font-size:12px;" onchange="getData()">

                                <br>To: <input type="date" id="end" name="trip-start"
                                    value="<?php echo date("Y-m-d"); ?>" min="2020-01-01"
                                    max="<?php echo date("Y-m-d"); ?>" class="custome_b" style="font-size:12px;"
                                    onchange="getData()">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="display">
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4" onclick="redirect('in-progress.php')"
                    ...
                    <div class="row ">
                            ...
                            <div class="card shadow mb-4" style="height:100%">
                                <div class="card-header py-3" style="display:flex;width:100%">
                                    ...
                                    <div class="tab" style="display:none">
                                        ...
                                        <div title="From <?php echo $firstday; ?>"><button class="tablinks text-primary"
                                                onclick="openIncident(event, 'weekly')">This Week</button></div>
                                        <div title="All"><button class="tablinks  text-primary "
                                                onclick="openIncident(event, 'all')" id="all_clic">All</button></div>
                                ...
                                <div class="card-body tabcontent" style="background-color: #fff;" id="all">
                                    ...
                                    <h4 class="small font-weight-bold">Other <span class="float-right">0%</span></h4>
                                    <div class="progress mb-4 cursor" style="height:20px" title="0">
                                        <div class="progress-bar bg-success" role="progressbar" style="width:0%"
                                            aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                        ...
                        <div class="col-lg-6 mb-2">
                            <div class="card shadow mb-4" id="rePie"><?php include("pie.php"); ?>

                            </div>


                            <div id="calendar-wrapper" class="card  shadow mb-2" style="margin-top:-3%;width:100%">
                            </div>
